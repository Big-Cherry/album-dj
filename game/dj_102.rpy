...
label .s09taxi:
    ...
    play sound arrived
    "百度地图雷萌萌版""到达目的地附近，导航结束。"
    "但是……此时出租处于一个导航上看不到路、车灯被环境的黑暗吞没的未知地点。"
    "你们和司机小哥都沉默了，沉默是今晚的康桥...."
    "……"
