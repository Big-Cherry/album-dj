...
label .s31love:
    ...
    "纪念册开发组""插播一个广告：敬请关注大樱桃纪念册第二部——密云之旅"
    han"我和诺诺是情感导师！"
    lian"灯光师！"
    wqbh"我要当配乐！"
    dan"那谁来做嘉宾呢？"
...
label .s32summer:
    ...
    小殷帅气能干，小陶温柔细心，他们俩对我来说都是亲人一样的存在。但就在这时，单纯的感情逐渐发生了变化……
    """
    menu:
        "如果是你，会期待谁的表白呢？"
        "帅气能干的小殷":
...
label .s35campus:
    ...
    但我还是放不下小殷，那段时间衔接班开课了，我和他每天都要坐班。{w}我们经常坐在教室后面聊一天，我们聊生活的一切，他知道我的所有，我也知道他的所有，我好像遇到了世界上另一个自己……

    可是我没想到，八月份开始军训以后，他突然对我冷淡了很多，我给他发消息，他总是过很长时间才回一两句，有时候甚至第二天才草草敷衍，而我却在屏幕另一端等得心力交瘁……
    
    最开始我以为我说错了话或者做错了事让他生气了，可是问他他却说我没错……{w}他说，对不起，我们还是做回普通朋友吧。
...
label .s37love:
    ...
    nuo"那你觉得之后有可能在一起吗？"
    tea"……"
    tian"这个问题我替她回答吧，我们之前也聊起过这个话题，我也不奢望之后能和她在一起，我也尊重她最后的决定。{w}还是那句话，我不在乎，只想要她开心。"
